  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, i) => (
          <div
            className="flex items-center justify-center p-4 text-xl font-semibold text-center border-2 border-purple-400 rounded-[15px] select-none box-border relative"
            key={i}
            style={{
