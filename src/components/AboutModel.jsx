...
export default function AboutModel({ fov = 75 }) { // Default FOV to 35, can be overridden via props
  ...
  useEffect(() => {
    ...
    const camera = new THREE.PerspectiveCamera(
      fov, // Use the fov prop here
      mountRef.current.clientWidth / mountRef.current.clientHeight,
      0.1,
      1000
    );
    camera.position.set(0, 0, 600); // Center the camera on the model
    ...
    loader.load(
      "/rocket.glb", // make sure this is in the public folder
      (gltf) => {
